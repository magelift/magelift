...
Defines local Docker Magento workflows, dependency preflight, and catalog-backed service selection without pretending to recreate managed cloud control planes.
