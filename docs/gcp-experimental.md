...
- Pulumi mocks: `go test ./providers/gcp/...` (preview / standard / HA graphs)
...
- WIF unit proof: `GOMAXPROCS=1 GOFLAGS=-p=1 go test ./providers/gcp/bootstrap/ -count=1 -run 'WIF|Identity'`
- Composer SM: `GOMAXPROCS=1 GOFLAGS=-p=1 go test ./providers/gcp/secrets/ ./internal/cli/ -count=1 -run 'Secret|Composer|GCP'`
