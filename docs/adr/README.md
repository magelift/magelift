...
- [ADR 0001](0001-aws-ecs-fargate-v1.md): AWS ECS Fargate as the first certified runtime (GCP Autopilot later certified; see ADR 0007).
...
- [ADR 0010](0010-database-dump-seed.md): Database dump seed for new/ephemeral envs (attach-out-of-scope consequence superseded by Phase 8 / ATTACH-02; see [brownfield-attach](../brownfield-attach.md)).
