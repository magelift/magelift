...
func TestProgramBuildsMockGraph(t *testing.T) {
	spec := Spec{
		...
		Catalog:      CatalogSelection{CloudSQLTier: "db-custom-1-3840", MemorystoreNodeType: "SHARED_CORE_NANO", AutopilotCPURequest: "500m", AutopilotMemoryRequest: "1Gi", DesiredWebReplicas: 1},
