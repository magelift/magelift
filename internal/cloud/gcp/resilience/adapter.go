...
// NewFromFactory validates the exact GCP target identity before constructing
// a provider-owned SDK client.
...
// NewLifecycleFactories adapts an injected GCP SDK operation client to the
// planned provider-neutral module seam.
