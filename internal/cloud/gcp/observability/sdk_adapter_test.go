...
func TestSDKAdapterBridgeValidatesGCPIdentity(t *testing.T) {
	...
	request := provider.ClientRequest{TargetID: "gcp-gke", Provider: "gcp", Runtime: "gke-standard", AccountOrProjectRef: "project-id", Region: "europe-west1", OwnershipMarker: "magelift/test"}
