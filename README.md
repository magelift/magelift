...
| AWS EKS Autopilot, OVH MKS, Scaleway Kapsule | Experimental |
...
Prefer **GitHub Release archives** (checksums + SBOM from GoReleaser on tag).
After `v1.0.0-rc.1`:

1. Download the archive for your OS/arch from
   [Releases](https://github.com/magelift/magelift/releases).
