...
// Magelift requires track the latest published candidate; each release
// bumps them to its own tags. The go.work workspace resolves local
// imports for development; GOWORK=off builds resolve these versions
// from the proxy (see tests/distribution).
...
require (
	...
	github.com/magelift/magelift v0.1.0-alpha.1-rc.15
	github.com/magelift/magelift/sdk v0.1.0-alpha.1-rc.15
