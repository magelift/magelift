...
# Magelift GCP DIY state is GCS. A leftover global `pulumi login` pointed at an
# AWS S3 backend makes destroy/preview fail with S3 301 and falsely blocks
# create-once. Default to the bootstrap bucket name when unset.
